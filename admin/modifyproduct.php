                            ...
                            echo "<table>";
                                ...
                                echo "<tbody>";
										echo "<tr>";
											  ...
											  echo "<td><button type='submit' value='".$row['PID']."' class='modify-button' name='pid'>Modify</button></td>";
											  echo "</form>";
					...
					if(mysqli_num_rows($result1)>0)
					{
						...
						while($rows=mysqli_fetch_array($result1))
						{
											...
											echo "<tr>";
												  ...
												  echo "<form action='update.php' method='post'>";
											  echo "<td><button type='submit' value='".$rows['PID']."' class='modify-button' name='pid'>Modify</button></td>";
											  echo "</form>";
